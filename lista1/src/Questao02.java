...
public class Questao02 {
    public static void main(String[] args) {
        ...
        System.out.println("Quantos quilowatt foram consumidos na residencia?");
        ...
        System.out.printf("A residencia deve pagar um total de %.2f pela quantidade de kW utilizada\n", ((vlrSalarioMinimo*0.01)*quantidadekW)); 
        input.close();
    }
}
